...
if(isset($_POST['submit']))
{
	...
	$status=1;
	$query=mysqli_query($con,"insert into users(fullName,userEmail,password,rollNo,contactNo,status) values('$fullname','$email','$password','$rollno','$contactno','$status')");
...
error:function (){}
  ...
  <body>
	  <div id="login-page">
	  	<div class="container">
	<h3 align="center" style="color:#fff"><a href="../index.html" style="color:#fff">School Complaint Management System</a></h3>
	<hr />
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            ...
		            <br >
		            <input type="text" class="form-control" maxlength="8" name="rollno" placeholder="Roll Number" required="required" autofocus>
		            <br>
