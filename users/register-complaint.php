...
$query=mysqli_query($con,"insert into tblcomplaints(userId,complaintType,noc,complaintDetails,complaintFile) values('$uid','$complaintype','$noc','$complaintdetials','$compfile')");
