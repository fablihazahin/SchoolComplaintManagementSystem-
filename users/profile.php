...
$query=mysqli_query($con,"update users set fullName='$fname',rollNo='$rollno',class='$class',section='$section',contactNo='$contactno',address='$address',updationDate='$currentTime' where userEmail='".$_SESSION['login']."'");
if($query)
{
...
<label class="col-sm-2 col-sm-2 control-label">Roll Number</label>
 <div class="col-sm-4">
<input type="text" name="rollno" maxlength="8" required="required" value="<?php echo htmlentities($row['rollNo']);?>" class="form-control" readonly>
</div>
<label class="col-sm-2 col-sm-2 control-label">Class</label>
<div class="col-sm-4">
<input type="text" name="class" required="required" value="<?php echo htmlentities($row['class']);?>" class="form-control">
</div>
</div>
...
<div class="col-sm-4">
<input type="text" name="section" required="required" value="<?php echo htmlentities($row['section']);?>" class="form-control">
</div>
</div>
...
<?php } ?>
                          ...
                          <div class="form-group">
                           <div class="col-sm-10" style="padding-left:85% ">
